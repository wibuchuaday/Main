...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://103429419319364",
...
--     end
-- end);
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/wibuchuaday/MainV3/refs/heads/main/TestHack.txt"))();
...
spawn(function()
    while true do
        if _G.EnableHakiFortress then
            v53("Snow black", Vector3.new(- 4971.71826171875, 335.9582214355469, - 3720.0595703125));
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://103429419319364") then
                    return v729;
                end
            end
        end
...
local v92 = v16.Setting:AddToggle("Toggleblack", {
...
v17.Toggleblack:SetValue(false);
...
local v165 = v16.Sea:AddToggle("ToggleblackBelt", {
    Title = "Cày Đai Trắng",
    Description = "",
    Default = false
});
